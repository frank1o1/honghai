<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:57:"E:\honghai\fastadmin\addons\address\view\index\baidu.html";i:1547262126;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=<?php echo (isset($config['baidukey']) && ($config['baidukey'] !== '')?$config['baidukey']:''); ?>"></script>
