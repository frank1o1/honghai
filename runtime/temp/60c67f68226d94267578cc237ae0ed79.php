<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"E:\honghai\fastadmin\public/../application/admin\view\contact\add.html";i:1547263334;s:63:"E:\honghai\fastadmin\application\admin\view\layout\default.html";i:1547208566;s:60:"E:\honghai\fastadmin\application\admin\view\common\meta.html";i:1547208566;s:62:"E:\honghai\fastadmin\application\admin\view\common\script.html";i:1547208566;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">地图:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-map" class="form-control form-control" data-toggle="addresspicker"
                   data-input-id="c-address" data-lat-id="c-latitude" data-lng-id="c-longitude" type="text">
        </div>
    </div>
